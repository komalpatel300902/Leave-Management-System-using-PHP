...
if(isset($_SESSION['adminuser']))
	...
	if($result->num_rows > 0)
		...
		while($row = $result->fetch_assoc())
			...
			echo "<input type = 'hidden' name = 'designation' value = 'HOD'>";
			echo "<input type = 'hidden' name = 'dept' value = '".$row["Dept"]."'>";
			echo "<input type = 'hidden' name = 'emptype' value = 'Permanent'>";
			echo "<input type = 'hidden' name = 'empfee' value = 'Grant in Aid'>";
			
			echo "<tr><th> * Type of leave : </th><td><input type = 'text' name = 'leavetype' class = 'textbox shadow selected'></td></tr>";
